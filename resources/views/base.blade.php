    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                <a href="/" class="logo">
                    <img src="{{ asset('htdocs/img/456.png') }}" alt="navbar brand" class="navbar-brand">
                </a>
                                    ...
                                    <li>
                                        <div class="user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted">{{ auth()->user()->username }}</p><a href="/profile" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">PET SHOP</h2>
                                <h5 class="text-white op-7 mb-2">Kebutuhan Hewan Peliharaan Anda <i class="fa fa-heart heart text-danger"></i></h5>
                            </div>
        ...
        <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright ml-auto">
                        2020, made with <i class="fa fa-heart heart text-danger"></i> by <a href="#">Al-Khawarizmi Team</a>
                    </div>
                </div>
            </footer>
        </div>
